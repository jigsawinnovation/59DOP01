                ...
                <form action="<?php echo site_url('member/admin_access/login');?>" method="post" class="form-signin" autocomplete="off">
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-xs-12 col-sm-12 text-right">
                            &nbsp;<span id="wrn" style="font-size: 14px;"><?php echo $wrn;?></span>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-12 text-center">
                            <button type="submit" class="btn btn-primary btn-lg " style="background-color:rgb(25, 43, 57); border:0">เข้าสู่ระบบ</button>
                        </div>
                    </div>

                    <!-- <button class="btn btn-lg btn-primary btn-block" type="submit">Login</button> -->
                    <h2 style="font-size: 14px" class="text-center">กรมกิจการผู้สูงอายุ</h2>
                    <h2 style="font-size: 14px" class="text-center">กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์</h2>
                    <input type="submit" name="bt_submit" hidden='hidden'>
                </form>
                <h2 style="font-size: 14px" class="text-center">พบปัญหาการใช้งานระบบกรุณาติดต่อผู้ดูแลระบบ</h2>
                <h3 style="font-size: 14px;" class="text-center">© สงวนลิขสิทธ์โดย กรมกิจการผู้สูงอายุ พัฒนาโดย บริษัท จิ๊กซอว์ อินโนเวชั่น จำกัด เวอร์ชั่น 1.0</h3>
            </div>
        </div>
    </body>
