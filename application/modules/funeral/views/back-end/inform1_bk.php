                                   ...
                                   <!--
                                    ...
                                    -->
                                      ...
                                      <div id="tmp_menu" hidden='hidden'>
                                       <!--
                                        ...
                                        <?php if(!isset($tmp1['perm_status'])) {?>
                                                readonly 
                                              <?php }else{?> href="<?php echo site_url('funeral/funeral_list');?>" 
                                    ...
                                    <div class="panel-group" style="margin-bottom: 0px;">
                                          <div class="panel panel-default" style="border: 0">
                                              <div class="panel-heading"><h4>ข้อมูลผู้ยืนคำขอ (ผู้ยื่นขอรับเงินสงเคราห์ในการจัดงานศพผู้สูงอายุตามประเพณี)</h4></div>
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                      <div class="input-group" style="width: 295px;"> 
                                                           ...
                                                           <div class="input-group-btn" style="padding-bottom: 5px;">   
                                                              <button title="ตรวจสอบ" class="btn btn-default" id="bt_req_pid" style="  border-radius: 0px;"><i class="fa fa-id-card-o" aria-hidden="true"></i></button>
                                                           </div>
                                              ...
                                              <div id="datetimepicker1" class="col-10 input-group date has-error" data-date-format="dd-mm-yyyy">
                                                  <input title="วันที่แจ้งเรื่อง" placeholder="เลือกวันที่" class="form-control" type="text" name="fnrl_info[date_of_req]" value="<?php echo $fnrl_info['date_of_req'];?>" required />
                                          ...
                                          <div class="form-group row">
                                              ...
                                              <input title="เบอร์โทรศัพท์ (มือถือ)" placeholder="ตัวอย่าง 08XXXXXXXX" class="form-control" type="text" name="fnrl_info[req_tel_no_mobile]" value="<?php echo $fnrl_info['req_tel_no_mobile'];?>"/>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                          ...
                                          <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                         <div class="input-group" style="width: 295px;">
                                                          ...
                                                          <div class="input-group-btn" style="padding-bottom: 5px;">
                                                              <button title="ตรวจสอบ" class="btn btn-default elder_same_req" id="bt_elder_pid" style="  border-radius: 0px; left: 1px;"><i class="fa fa-id-card-o" aria-hidden="true"></i></button>
                                                          </div>
                                                        </div>
                                                    </div>
                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-content" style="padding-bottom: 0px">
                            <div class="table-responsive">
                                                ...
                                                <div class="form-group row">
                                                      <div class="col-xs-12 col-sm-3">
                                                         ...
                                                         <div id="datetimepicker2" class="col-10 input-group date has-error" data-date-format="dd-mm-yyyy">
                                                             <input title="วันที่เสียชีวิต" placeholder="เลือกวันที่" class="form-control" type="text" name="pers_info[date_of_death]" value="<?php echo @$pers_info['date_of_death']; ?>" required>
                                                             <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                         </div>
                                                          <script type="text/javascript">
                                                            $(function () {
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                         <label for="datetimepicker2" class="col-2 col-form-label" style="color: red;">วันที่ออกใบมรณบัตร </label>
                                                       <div id="datetimepicker3" class="col-10 input-group date has-error" data-date-format="dd-mm-yyyy">
                                                           <input title="วันที่ออกใบมรณบัตร" placeholder="เลือกวันที่" class="form-control" type="text" name="fnrl_info[date_of_death_certificate]" value="<?php echo @$fnrl_info['date_of_death_certificate']; ?>" required>
                                                           <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                       </div>
                                                        <script type="text/javascript">
                                                          $(function () {
                                          ...
                                          <div class="panel-group">
                                                <div class="panel panel-default" style="border: 0">
                                                    ...
                                                    <div class="panel-body" style="border:0; padding: 20px;">
                                                        <div class="form-group row">
                                                          ...
                                                          <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                               <div class="input-group" style="width: 295px;"> 
                                                                  ...
                                                                  <div class="input-group-btn" style="padding-bottom: 5px;">
                                                                    <button type="button" title="ตรวจสอบ" class="btn btn-default" id="bt_req_pers_aprv_pid" style="  border-radius: 0px; left: 1px;"><i class="fa fa-id-card-o" aria-hidden="true"></i></button>
                                                                  </div>
                                                               </div>
                                                        ...
                                                        <div class="form-group row">
                                                          <div class="col-xs-12 col-sm-3">
                                                              <label for="datetimepicker1" class="col-2 col-form-label" style="color: red;">วันที่รับรอง </label>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <input title="เบอร์โทรศัพท์ (บ้าน)" placeholder="ตัวอย่าง 02XXXXXXX ต่อ XXX" class="form-control" type="text" name="fnrl_info[req_pers_aprv_tel_no_home]" value="<?php echo $fnrl_info['req_pers_aprv_tel_no_home'];?>"/>
                                                          ...
                                                          <div class="col-xs-12 col-sm-3">
                                                              <label for="" class="col-2 col-form-label">เบอร์โทรศัพท์ (มือถือ)</label>
                                                    <input title="เบอร์โทรศัพท์ (มือถือ)" placeholder="ตัวอย่าง 08XXXXXXXX" class="form-control" type="text" name="fnrl_info[req_pers_aprv_tel_no_mobile]" value="<?php echo $fnrl_info['req_pers_aprv_tel_no_mobile'];?>"/>
                                                          </div>
                                                          <div class="col-xs-12 col-sm-3">
                                                              <label for="" class="col-2 col-form-label">เบอร์โทรสาร (แฟกซ์)</label>
                                                    ...
                                                    <div class="panel-group">
                                                          <div class="panel panel-default" style="border: 0">
                                                                  ...
                                                                  <div class="form-group row">
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                                      <div class="input-group" style="width: 295px;">
                                                                          ...
                                                                          <div class="input-group-btn" style="padding-bottom: 5px;">
                                                                             <button type="button" title="ตรวจสอบ" class="btn btn-default" id="bt_not_survey_aprv_pid" style="  border-radius: 0px; left: 1px;"><i class="fa fa-id-card-o" aria-hidden="true"></i></button>
                                                                          </div>
                                                                      </div>
                                                                      </div>
                                                                      <script>
                                                              ...
                                                              <div id="datetimepicker5" class="col-10 input-group date has-error" data-date-format="dd-mm-yyyy">
                                                                  <input title="วันที่รับรอง" placeholder="เลือกวันที่" class="form-control" type="text" name="fnrl_info[date_of_not_survey_aprv]" value="<?php echo @$fnrl_info['date_of_not_survey_aprv']; ?>" required/>
                                                                  <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                              </div>
                                                                <script type="text/javascript">
                                                                <?php
                                                          ...
                                                          <div class="form-group row">
                                                              ...
                                                              <input title="เบอร์โทรศัพท์ (บ้าน)" placeholder="ตัวอย่าง 02XXXXXXX ต่อ XXX" class="form-control" type="text" name="fnrl_info[not_survey_aprv_tel_no_home]" value="<?php echo @$fnrl_info['not_survey_aprv_tel_no_home'];?>"/>
                                                                    ...
                                                                    <div class="col-xs-12 col-sm-3">
                                                                        <label for="" class="col-2 col-form-label">เบอร์โทรศัพท์ (มือถือ)</label>
                                                              <input title="เบอร์โทรศัพท์ (มือถือ)" placeholder="ตัวอย่าง 08XXXXXXXX" class="form-control" type="text" name="fnrl_info[not_survey_aprv_tel_no_mobile]" value="<?php echo @$fnrl_info['not_survey_aprv_tel_no_mobile'];?>"/>
                                                                    </div>
                                                                    <div class="col-xs-12 col-sm-3">
                                                                        <label for="" class="col-2 col-form-label">เบอร์โทรสาร (แฟกซ์)</label>
                                ...
                                <div class="col-xs-12 col-sm-2">
                                  <button style="width: 100%;" type="button" class="btn btn-primary btn-md" onclick="window.location.href='<?php echo site_url('funeral/funeral_list');?>'"> ล้างค่า</button>
                                </div>
                              </div><!-- close class row-->
