...
class Getdata extends CI_Controller {
	...
	public function diffInfoCM($area_id=0) {
		if (isset($_SERVER['HTTP_ORIGIN'])) {
				header("Access-Control-Allow-Origin: {$_SERVER['HTTP_ORIGIN']}");
				header('Access-Control-Allow-Credentials: true');
				header('Access-Control-Max-Age: 86400');    // cache for 1 day
		...
		if($area_id==0) {
			echo json_encode($this->difficult_mobile_model->getAll_diffInfoAreaCM('50010000'));
		}else {
			echo json_encode($this->difficult_mobile_model->getAll_diffInfoAreaCM($area_id));
		}
	}
...
<<<<<<< HEAD
	...
	public function report1Trouble() {
					//if (isset($_SERVER['HTTP_ORIGIN'])) {
							header("Access-Control-Allow-Origin: {$_SERVER['HTTP_ORIGIN']}");
							header('Access-Control-Allow-Credentials: true');
							header('Access-Control-Max-Age: 86400');    // cache for 1 day
					//}
					//'.json_encode($res_data).'
					$res_data = $this->difficult_mobile_model->getReport1Trouble();
	...
	public function report2Trouble() {
					//if (isset($_SERVER['HTTP_ORIGIN'])) {
							header("Access-Control-Allow-Origin: {$_SERVER['HTTP_ORIGIN']}");
							header('Access-Control-Allow-Credentials: true');
							header('Access-Control-Max-Age: 86400');    // cache for 1 day
