                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="tmp_menu" hidden='hidden'>
                                            ...
                                            <?php
                                              ...
                                              $tmp1 = $this->admin_model->chkOnce_usrmPermiss(3,$user_id); //Check User Permission
                                            ?>
                                            <a onclick="return opnBck()" class="navbar-minimalize minimalize-styl-2 btn btn-primary" style="margin-top: 11px; margin-left: 0px; background-color: #2f4250; border: 0;font-size: 17px; padding: 5px 20px 3px 20px;" 
                                            <?php if(!isset($tmp1['perm_status'])) {?>
                                                    readonly 
                                                  <?php }else{?> href="<?php echo site_url('difficult/assist_list'); ?>" 
                                            <?php }?> title="<?php if(isset($tmp['app_name'])){echo $tmp['app_name'];}?>">
                                            ...
                                            <?php
                                              ...
                                              $tmp1 = $this->admin_model->chkOnce_usrmPermiss(3,$user_id); //Check User Permission
                                            ?>
                                            <a data-id=<?php echo $diff_info['diff_id'];?> onclick="opn(this)" class="navbar-minimalize minimalize-styl-2 btn btn-primary" style="margin-top: 11px; margin-left: 0px; background-color: #2f4250; border: 0;font-size: 17px; padding: 5px 20px 3px 20px;" 
                                            <?php if(!isset($tmp1['perm_status'])) {?>
                                                    readonly 
                                                  <?php }else{ ?>  
                                            <?php }?> title="<?php if(isset($tmp['app_name'])){echo $tmp['app_name'];}?>">
                                    ...
                                    <div class="panel-group">
                                          <div class="panel panel-default" style="border: 0">
                                              ...
                                              <div class="panel-body" style="border:0; padding: 20px;">
                                                  <div class="form-group row">
                                                    <div class="col-xs-12 col-sm-3">
                                                      <img id="test2" src="<?php echo path(get_session('user_photo_file'),'member');?>" class="img-responsive" style="margin: 0 auto;">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3" style="padding: 11px 15px;"><span style="font-weight: bold; color: red;">เลขประจำตัวประชาชน</span></div>
                                                    <div class="col-xs-12 col-sm-3 has-error" style="padding: 3px 15px;">
                                                      <input title="เลขประจำตัวประชาชน" placeholder="เลขประจำตัวประชาชน (13 หลัก)" class="form-control input_idcard" type="text" value="<?php echo $diff_info['req_pid'];?>" name="diff_info[req_pid]" id="req_pid" autofocus/>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3" style="padding: 1px 15px;">
                                                      <button title="ตรวจสอบ" class="btn btn-default" id="bt_req_pid" onclick="return false;">ตรวจสอบ</button>
                                                      <script>
                                                        var req_pers = null;
                                                    ...
                                                    <div class="col-xs-12 col-sm-6" style="padding: 11px 15px;" id="req_name"> <?php echo $diff_info['req_name'];?> </div>

                                                    <div class="col-xs-12 col-sm-3" style="padding: 11px 15px;"><span style="font-weight: bold;">วันเดือนปีเกิด</span></div>
                                                    <div class="col-xs-12 col-sm-6" style="padding: 11px 15px;" id="req_date_of_birth"> <?php echo $diff_info['req_date_of_birth'];?> </div>

                                                    <div class="col-xs-12 col-sm-3" style="padding: 11px 15px;"><span style="font-weight: bold;">เพศ</span> <span id="req_gender_name"> <?php echo $diff_info['req_gender_name'];?> </span> </div>
                                                    <div class="col-xs-12 col-sm-3" style="padding: 11px 15px;"><span style="font-weight: bold;">สัญชาติ</span> <span id="req_nation_name_th"> <?php echo $diff_info['req_nation_name_th'];?> </span> </div>
                                                    
                                                    <div class="col-xs-12 col-sm-3" style="padding: 11px 15px;"><span style="font-weight: bold;">ศาสนา</span> <span id="req_relg_title"> <?php echo $diff_info['req_relg_title'];?> </span> </div>

                                                    <div class="col-xs-12 col-sm-3" style="padding: 11px 15px;"><span style="font-weight: bold;">ที่อยู่ตามทะเบียนบ้าน</span></div>
                                                    <div class="col-xs-12 col-sm-6" style="padding: 11px 15px;" id="req_reg_addr"> <?php echo @$diff_info['req_reg_add_info']; ?> </div>
                                                  </div>
                                                  <div class="form-group row">
                                                    <div class="col-xs-12 col-sm-3">
                                              ...
                                              <input title="หนว่ยงานต้นสังกัด" placeholder="ระบุหนว่ยงานต้นสังกัด" class="form-control" type="text" name="diff_info[req_org]" value="<?php echo $diff_info['req_org'];?>"/>                   
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                          ...
                                          <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3" style="padding: 1px 15px;">
                                                      <button title="ตรวจสอบ" class="btn btn-default elder_same_req" id="bt_elder_pid" onclick="return false;">ตรวจสอบ</button> 
                                                    ...
                                                    <div class="col-xs-12 col-sm-3" style="padding: 11px 15px;"><span style="font-weight: bold;">ที่อยู่ตามทะเบียนบ้าน</span><input type="hidden" id="reg_addr_id" name="pers_info[reg_addr_id]" value="<?php echo $diff_info['reg_addr_id']; ?>"></div>
                                                    <div class="col-xs-12 col-sm-6" style="padding: 11px 15px;" id="reg_addr"> <?php echo @$diff_info['reg_add_info']; ?> </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6"><button class="btn btn-default" onclick="return false;"> <i class="fa fa-map-marker" aria-hidden="true"></i> ตำแหน่งพิกัดภูมิศาสตร์</button> <span>(102.5745382539, 97.394903489)</span></div>
                                                  </div>
                                              ...
                                              <input title="ราบได้เฉลี่ย (บาท/เดือน)" placeholder="ระบุราบได้เฉลี่ย (บาท/เดือน)" class="form-control" type="text" name="pers_info[mth_avg_income]" value="<?php echo @$diff_info['mth_avg_income']; ?>"/>                   
                                                    </div>
                                              ...
                                              <label><input type="radio" name="pers_info[dept_status]" value="ไม่มีหนี้สิน" <?php if(@$diff_info['dept_status'] == 'ไม่มีหนี้สิน') { echo "checked";} ?>> ไม่มีหนี้สิน</label>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                                        <label for="" class="col-2 col-form-label">&nbsp;</label><br>
                                              <label><input type="radio" name="pers_info[dept_status]" value="มีหนี้สิน" <?php if(@$diff_info['dept_status'] == 'มีหนี้สิน') { echo "checked";} ?>> มีหนี้สิน</label>
                                                    </div>
