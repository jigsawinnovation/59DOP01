                ...
                <div class="panel panel-default" style="border: 0">
                  ...
                  <div class="panel-body" style="border:0; padding: 20px; ">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-xs-12 col-sm-3">
                        <center>
                          ...
                          <div class="col-xs-12 col-sm-6 has-error " style="padding: 3px 15px;">
                            ...
                            <div class="input-group" style="width: 295px;">
                              ...
                              <div class="input-group-btn" style="padding-bottom: 5px;">
                                <button type="button" title="ตรวจสอบ" class="btn btn-default" id="bt_req_pid" style="background-color:#F2DEDE; border-radius: 0px; border-color: #ed5565; color: #ed5565;padding:5px 12px;"><i class="fa fa-search" aria-hidden="true"></i></button>
                              </div>
                          ...
                          <div class="col-xs-12 col-sm-6" style="padding: 7px 15px;"><span style="font-weight: bold;">สัญชาติ</span> <span id="req_nation_name_th"> <?php echo $diff_info['req_nation_name_th'];?> </span> </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-xs-12 col-sm-3">
                        ...
                        <input title="เบอร์โทรศัพท์ (ที่ติดต่อได้)" placeholder="ตัวอย่าง 08XXXXXXXX" class="form-control" type="text" name="diff_info[tel_no]" value="<?php echo $diff_info['req_tel_no'];?>"/>
                      </div>
                      ...
                      <!-- <div class="col-xs-12 col-sm-3">
                        <label class="col-2 col-form-label">เบอร์โทรสาร (แฟกซ์)</label>
                  ...
                  <div class="panel-heading">
                      ...
                      <font >ข้อมูลผู้สูงอายุ (ผู้ขอรับการสงเคราะห์) </font>
                           <div class="checkbox-inline i-checks" >(&nbsp;<input type="checkbox" name="elder_pers_chk" id="elder_pers_chk"  <?php if($adm_info['req_pers_id']==@$adm_info['pers_id'] && $adm_info['req_pers_id'] != ''){ echo "checked"; }?> >  บุคคลเดียวกับผู้ยื่นคำขอ )</div>
                      &nbsp;
                      <!--
                    ...
                    <div class="panel-body" style="border:0; padding: 20px; padding-bottom: 0px;">
                      <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                         ...
                         <div class="input-group" style="width: 295px;">
                            <input title="เลขประจำตัวประชาชน" placeholder="เลขประจำตัวประชาชน (13 หลัก)" class="form-control input_idcard elder_same_req" type="text" id="elder_pid" name="diff_info[pid]" value="<?php echo $diff_info['pid'];?>" />
                            <div class="input-group-btn" style="padding-bottom: 5px;">
                                  <button type="button" title="ตรวจสอบ" class="btn btn-default elder_same_req r" id="bt_elder_pid" style="background-color:#F2DEDE;  border-radius: 0px; border-color: #ed5565;color: #ed5565;padding:5px 12px;"><i class="fa fa-search" aria-hidden="true"></i></button>
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-6" style="padding: 7px 15px;"><span style="font-weight: bold;">สัญชาติ</span> <span id="nation_name_th"> <?php echo $diff_info['nation_name_th'];?></span> </div>
                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="col-xs-12 col-sm-4"><font >ที่อยู่ (ปัจจุบัน) </font> (&nbsp; <div  class="checkbox-inline i-checks" ><input  type="checkbox" name="elder_addr_chk" id="elder_addr_chk"> <i></i> ตรงกับที่อยู่ตามทะเบียนบ้าน )</div></div>
                        ...
                        $(document).ready(function (){
                          ...
                          <?php
                          if(($diff_info['reg_addr_id']==$diff_info['pre_addr_id']) && (($diff_info['reg_addr_id'] != '' || $diff_info['reg_addr_id'] != '0' ) && ($diff_info['pre_addr_id']!='' && $diff_info['pre_addr_id']!='0' ))) {
                            ?>
                        ...
                        $("input[name='elder_addr_chk']").on('ifChecked', function(event){
                            $(".pre_addr_dev").hide();
                        });
                        $("input[name='elder_addr_chk']").on('ifUnchecked', function(event){
                            $(".pre_addr_dev").show();
                        });
                    ...
                    <div class="form-group row">
                      ...
                      <div class="form-group row">
                        <div class="col-xs-12 col-sm-3">
                          <label class="col-2 col-form-label">เบอร์โทรศัพท์ (ที่ติดต่อได้)</label>
                          <input title="เบอร์โทรศัพท์ (ที่ติดต่อได้)" placeholder="ตัวอย่าง 02XXXXXXX ต่อ XXX" class="form-control" type="text" name="pers_info[tel_no]" value="<?php echo @$diff_info['tel_no'];?>"/>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-3 dropdown">
                          ...
                          <div class="col-10">
                            <select title="สถานะการสมรส" placeholder="เลือกสถานะการสมรส" class="form-control" name="pers_info[marital_status]">
                              ...
                              <option value="สมรส อยู่ด้วยกัน" <?php if(@$diff_info['marital_status'] == 'สมรส อยู่ด้วยกัน'){ echo "selected"; } ?>>สมรส อยู่ด้วยกัน</option>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-3">
                          <label class="col-2 col-form-label">รายได้เฉลี่ย (บาท/เดือน)</label>
                          <input title="รายได้เฉลี่ย (บาท/เดือน)" placeholder="ระบุรายได้เฉลี่ย (บาท/เดือน)" class="form-control numberonly" type="text" name="pers_info[mth_avg_income]" value="<?php echo @$diff_info['mth_avg_income']; ?>"/>
                        </div>
                        <div class="col-xs-12 col-sm-3 dropdown">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-xs-12 col-sm-3">
                          ...
                          <input title="เงินกู้ในระบบ" placeholder="ระบุจำนวนเงิน (บาท)" class="form-control numberonly" type="text" name="pers_info[dept_loan_system]" value="<?php echo @$diff_info['dept_loan_system']; ?>" />
                        </div>
                        <div class="col-xs-12 col-sm-3">
                          <label class="col-2 col-form-label">เงินกู้นอกระบบ (บาท)</label>
                          <input title="เงินกู้นอกระบบ" placeholder="ระบุจำนวนเงิน (บาท)" class="form-control numberonly" type="text" name="pers_info[dept_loan_shark]"  value="<?php echo @$diff_info['dept_loan_shark']; ?>"/>
                        </div>
                      </div>
