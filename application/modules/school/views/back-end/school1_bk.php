                            ...
                            <div id="tab-1" <?php if($usrpm['app_id']==59){?>class="tab-pane active" <?php }else{?> class="tab-pane"<?php }?>>
                                <div class="panel-body">
                                    ...
                                    <div id="tmp_menu" hidden='hidden'>
                                            ...
                                            <?php if(!isset($tmp1['perm_status'])) {?>
                                                    readonly 
                                                  <?php }else{?> href="<?php echo site_url('school/school_list'); ?>" 
                                              ...
                                              <div class="panel-body" style="border:0; padding: 20px;">
                                                ...
                                                <div class="form-group row">
                                                  ...
                                                  <div class="col-xs-12 col-sm-3">
                                                      ...
                                                      <br>
                                                      <select  style="width: 25%; padding: 4px 12px;" name="schl_info[schl_established_date]">
                                                          ...
                                                          ?>
                                                              ...
                                                              <option value="<?php echo $day_two; ?>" <?php if($schl_info['schl_established_date']==$day_two){ echo "selected"; }?> ><?php echo $day; ?></option>
                                                          <?php }?>
                                                      </select>
                                                      ...
                                                      <select  style="width: 40%; padding: 4px 12px;" name="schl_info[schl_established_month]">
                                                              <option>เดือน</option>
                                                          <?php foreach($mount as $key=>$value){ ?>
                                                              <option value="<?php echo $key; ?>" <?php if($schl_info['schl_established_month']==$key){ echo "selected"; }?> ><?php echo $value; ?></option>
                                                          <?php } ?>
                                                      </select>
                                                      <select  style="width: 30%; padding: 4px 12px;" name="schl_info[schl_established_year]">
                                                              <option>ปี</option>
                                                          <?php for($year = date("Y")-100;$year<=date("Y");$year++){ ?>
                                                              <option value="<?php echo $year; ?> " <?php if($schl_info['schl_established_year']==$year){ echo "selected"; }?> ><?php echo $year+543; ?></option>
                                                          <?php } ?>
                                                      </select>
                                                  </div>
                                                </div>
                                               ...
                                               <div class="form-group row">
                                                    <div class="col-xs-12 col-sm-3 dropdown">
                                                        ...
                                                        <div class="col-10">
                                                          <select title="ตรอก" placeholder="เลือกตรอก" class="form-control elder_addr_pre" id="alley" name="schl_info[addr_alley]">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3 dropdown">
                                                      ...
                                                      <div class="col-10">
                                                        <select title="ซอย" placeholder="เลือกซอย" class="form-control elder_addr_pre" id="lane" name="schl_info[addr_lane]">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 dropdown">
                                                      ...
                                                      <div class="col-10">
                                                        <select title="ถนน" placeholder="เลือกถนน" class="form-control elder_addr_pre" id="road" name="schl_info[addr_road]">
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        ...
                                                        <input title="เบอร์โทรศัพท์ (บ้าน)" placeholder="ตัวอย่าง 02XXXXXXX ต่อ XXX" class="form-control" type="text" name="schl_info[tel_no_home]" value="<?php echo $schl_info['tel_no_home'];?>"/>
                                                    </div>
                                    ...
                                    <div class="col-xs-12 col-sm-2">
                                      <button style="width: 100%;" type="button" class="btn btn-primary btn-md" onclick="window.location.href='<?php echo site_url('school/school_list');?>'"> ล้างค่า</button>
                                    </div>
                                  </div><!-- close class row-->
