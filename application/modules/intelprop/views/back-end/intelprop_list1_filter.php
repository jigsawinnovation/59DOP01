     ...
     <div class="container-fluid">
        ...
        <div class="form-group row">
          <div class="col-xs-12 col-sm-3">
            <h3><label for="col2_filter">โครงการ/กิจกรรม:</label></h3>
          </div>
          <div class="col-xs-12 col-sm-6">
            <input data-column="1" type="text" class="form-control column_filter" id="col1_filter" placeholder="ชื่อโครงการ/กิจกรรม">
          </div>
        </div>


         <div class="form-group row">
          <div class="col-xs-12 col-sm-3"><h3><label>พื้นที่ดำเนินการ:</label></h3></div>
      ...
      <!--   <div class="form-group row">
          <div class="col-xs-12 col-sm-3">
            <h3><label for="col2_filter">พื้นที่ดำเนินการ:</label></h3>
          </div>
          <div class="col-xs-12 col-sm-6">
            <input data-column="2" type="text" class="form-control column_filter" id="col2_filter" placeholder="ชื่อพื้นที่ดำเนินการ">
          </div>
        </div> -->

        <div class="form-group row">
          <div class="col-xs-12 col-sm-3">
            <h3><label for="col2_filter">ชื่อตัว-ชื่อสกุล (ผู้รับผิดชอบโครงการ):</label></h3>
          </div>
          <div class="col-xs-12 col-sm-6">
        ...
        <div class="form-group row">
          ...
          <div class="col-xs-12 col-sm-3">
            <select class="form-control" id="statusoper">
               ...
               <option value="date_of_operate">วันที่ดำเนินการ</option>
