                                  ...
                                  <div class="panel-body" style="background-color:#FBFBFB;border: 1px #eee solid; padding: 15px;">
                                    ...
                                    <div class="form-group row">
                                      <div class="col-xs-12 col-sm-3">
                                        ...
                                        <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" name="care_pers_info[healthy][myID]" value="ปกติ" checked> ปกติ</label></div>
                                        <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" name="care_pers_info[healthy][myID]" value="ป่วยเรื้อรัง"> ป่วยเรื้อรัง</label></div>
                                        <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" name="care_pers_info[healthy][myID]" value="พิการ"> พิการ</label></div>
                                      </div>
                                      <div class="col-xs-12 col-sm-3">
                                        <label for="" class="col-2 col-form-label">ช่วยเหลือตนเอง</label>
                                        <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" name="care_pers_info[healthy_self_help][myID]" value="ได้" checked> ได้</label></div>
                                        <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" name="care_pers_info[healthy_self_help][myID]" value="ไม่ได้"> ไม่ได้</label></div>
                                      </div>
                                      <div class="col-xs-12 col-sm-3">
                                        <label for="" class="col-2 col-form-label">สาเหตุการพ้นการดูแล</label>
                                        <?php
                                        $rows = $this->common_model->custom_query("select * from std_cause_of_care");
                                        foreach($rows as $key=>$row) {
                                        ?>
                                        <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" class="care_cause_code" data-index=myID name="care_pers_info[care_cause_code][myID]" value="<?php echo $row['cause_code'];?>"> <?php echo $row['cause_of_care'];?></label></div>
                                        <?php
                                        }
                                        ?>
                                      </div>
                                      <div class="col-xs-12 col-sm-3">
                                        <input id="care_cause_ident-myID" type="text" class="form-control" title="สาเหตุการพ้นการดูแลอื่น ๆ (ระบุ)" placeholder="อื่น ฯ (ระบุ)" name="care_pers_info[care_cause_identify][myID]" value="" disabled="">
                                      </div>
                                    </div>
                                  ...
                                  getPersInfo(inputpid_myID,bt_spid_myID,setData_myID); //Get Data
                                    ...
                                    $(inputpid_myID).select();
                                        ...
                                        <div class="training_template" hidden='hidden'>
                                            ...
                                            <div class="col-xs-12 col-sm-3">
                                              <label for="datetimepicker_tmyID" class="col-2 col-form-label">วันที่ได้รับการอบรม</label>
                                              <div id="datetimepicker_tmyID" class="col-10 input-group date" data-date-format="dd-mm-yyyy">
                                                <input title="วันที่ได้รับการอบรม" placeholder="เลือกวันที่" class="form-control training" type="text" name="training[date_of_training][myID]" disabled />
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                              </div>
                                              <script type="text/javascript">
                                            $(function () {
                                            $("#datetimepicker_tmyID").datepicker({
                                              autoclose: true,
                                              todayHighlight: true,
                                              format: 'dd/mm/yyyy',
                                               todayBtn: true,
                                            ...
                                            <div class="col-xs-12 col-sm-3">
                                              ...
                                              <input title="จากหน่วยงาน" placeholder="จากหน่วยงาน" class="form-control training" type="text" name="training[older_care_training_org][myID]" disabled />
                                            </div>
                                            <div class="col-xs-12 col-sm-3">
                                              <label for="" class="col-2 col-form-label">หลักสูตร</label>
                                              <input title="หลักสูตร" placeholder="ระบุหลักสูตร" class="form-control training" type="text" name="training[older_care_training_course][myID]" disabled />
                                            </div>
                                ...
                                <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                  ...
                                  <div class="input-group" style="width: 295px;">
                                    ...
                                    <div class="input-group-btn" style="padding-bottom: 5px;">
                                      <button title="ตรวจสอบ" class="btn btn-default elder_same_req" id="bt_req_pid" type="button" style="background-color:#F2DEDE; border-radius: 0px; border-color: #ed5565; color: #ed5565;padding:5px 12px;"><i class="fa fa-search" aria-hidden="true"></i></button>
                                      <!--<button class="btn btn-default elder_same_req" title="กรณีไม่มีบัตร" style="display: none;">กรณีไม่มีบัตร</button>-->
                                        ...
                                        <div class="form-group row">
                                          <div class="col-xs-12 col-sm-3">
                                            ...
                                            <div id="datetimepicker1" class="col-10 input-group date has-error" data-date-format="dd-mm-yyyy">
                                              <input title="วันที่ขึ้นทะเบียน" placeholder="เลือกวันที่" class="form-control" type="text" name="volt_info[date_of_reg]" required />
                                              <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                            <script type="text/javascript">
                                            <?php
                                        ...
                                        <div class="form-group row">
                                          ...
                                          <script>
                                            ...
                                            function icheck_loop () {
                                              ...
                                              $(".care_cause_code").on('ifClicked',function(){
                                        ...
                                        <div class="training_members" style="margin-top:-15px">
                                        <?php 
                                        $j=0;
                                        if(($process_action!='Add')&&($process_action!='Added')){
                                          foreach($volt_info_training as $key_training => $value_training ){
                                        ?>
                                            <div class="row">
                                            <div class="col-xs-12 col-sm-2">
                                              &nbsp;
                                              <input type="hidden" name="training[train_id][<?php echo $j; ?>]" value="<?php echo $value_training['train_id']; ?>">
                                            </div>
                                            <div class="col-xs-12 col-sm-3">
                                              <label for="datetimepicker_t<?php echo $j;?>" class="col-2 col-form-label">วันที่ได้รับการอบรม</label>
                                              <div id="datetimepicker_t<?php echo $j;?>" class="col-10 input-group date" data-date-format="dd-mm-yyyy">
                                                <input title="วันที่ได้รับการอบรม" placeholder="เลือกวันที่" class="form-control training" type="text" name="training[date_of_training][<?php echo $j;?>]" />
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                              </div>
                                              <script type="text/javascript">
                                            <?php
                                            $tmp = explode('-',@$value_training['date_of_training']);
                                            ?>
                                            $(function () {
                                            $("#datetimepicker_t<?php echo $j;?>").datepicker({
                                              autoclose: true,
                                              todayHighlight: true,
                                              format: 'dd/mm/yyyy',
                                               todayBtn: true,
                                               language: 'th',
                                               thaiyear: true
                                            })<?php if(count($tmp)==3 && $value_training['date_of_training']!='0000-00-00'){?>.datepicker('update', new Date(Date.UTC(<?php echo $tmp[2];?>,<?php echo $tmp[1];?>-1,<?php echo $tmp[0];?>)));<?php }?>
                                            });
                                              </script>
                                            </div>
                                            <div class="col-xs-12 col-sm-3">
                                              <label for="" class="col-2 col-form-label">จากหน่วยงาน</label>
                                              <input title="จากหน่วยงาน" placeholder="จากหน่วยงาน" class="form-control training" type="text" name="training[older_care_training_org][<?php echo $j;?>]" value="<?php echo $value_training['older_care_training_org'];?>" />
                                            </div>
                                            <div class="col-xs-12 col-sm-3">
                                              <label for="" class="col-2 col-form-label">หลักสูตร</label>
                                              <input title="หลักสูตร" placeholder="ระบุหลักสูตร" class="form-control training" type="text" name="training[older_care_training_course][<?php echo $j;?>]" value="<?php echo $value_training['older_care_training_course'];?>" />
                                            </div>
                                            <div class="col-xs-12 col-sm-1">
                                        ...
                                        <?php
                                          ...
                                          <div class=row>
                                            ...
                                            <div class="col-xs-12 col-sm-10 text-left" style="margin-top:4px;">
                                                  <button type="button" class="btn btn-default" id="btAdd_training"><i class="fa fa-plus" aria-hidden="true"></i></button>
                                            </div>
                                          </div>

                                            <script>
                                              var nummt = <?php echo $j;?>;
                                              var cloneTmp_t = $('.training_template').clone();
                                              function addTrnMember() {
                                                if(!$("input[name='volt_info[older_care_training]']").prop("checked")) {
                                                  var cloneTmp0 = cloneTmp_t.html().replace(new RegExp("myID", 'g'), nummt);
                                                  nummt = nummt+1;
                                                  $(cloneTmp0).clone().appendTo('.training_members');
                                                  $(".training").prop('disabled', false);
                                                }
                                              }
                                              ...
                                              <?php
                                              if(($process_action!='Add' && $process_action!='Added') && $volt_info['older_care_training']=='เคยได้รับการอบรม'){
                                              ?>
                                                $(".training").prop('disabled', false);
                                              <?php
                                              }
                                                      ...
                                                      <div class="panel panel-default" style="border: 0">
                                                        ...
                                                        <div class="panel-body" style="background-color:#FBFBFB;border: 1px #eee solid; padding: 15px;">
                                                          ...
                                                          <div class="form-group row">
                                                            <div class="col-xs-12 col-sm-3">
                                                              <label for="" class="col-2 col-form-label">ปัญหาสุขภาพ</label>
                                                              <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" name="care_pers_info[healthy][<?php echo $i;?>]" value="ปกติ" <?php if($value_elderly['care_health_problems']=="ปกติ") {?>checked<?php }?>> ปกติ</label></div>
                                                              <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" name="care_pers_info[healthy][<?php echo $i;?>]" value="ป่วยเรื้อรัง" <?php if($value_elderly['care_health_problems']=="ป่วยเรื้อรัง") {?>checked<?php }?>> ป่วยเรื้อรัง</label></div>
                                                              <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" name="care_pers_info[healthy][<?php echo $i;?>]" value="พิการ"  <?php if($value_elderly['care_health_problems']=="พิการ") {?>checked<?php }?>> พิการ</label></div>
                                                            </div>
                                                            <div class="col-xs-12 col-sm-3">
                                                              <label for="" class="col-2 col-form-label">ช่วยเหลือตนเอง</label>
                                                              <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" name="care_pers_info[healthy_self_help][<?php echo $i;?>]" value="ได้" <?php if($value_elderly['care_help_yourself']=="พิการ") {?>checked<?php }?>> ได้</label></div>
                                                              <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" name="care_pers_info[healthy_self_help][<?php echo $i;?>]" value="ไม่ได้" <?php if($value_elderly['care_help_yourself']=="ไม่ได้") {?>checked<?php }?>> ไม่ได้</label></div>
                                                            </div>
                                                            <div class="col-xs-12 col-sm-3">
                                                              <label for="" class="col-2 col-form-label">สาเหตุการพ้นการดูแล</label>
                                                              <?php
                                                              ...
                                                              foreach($rows as $key=>$row) {
                                                              ?>
                                                              <div class="checkbox-inline i-checks"><label style="font-weight: normal"><input type="radio" class="care_cause_code" data-index=<?php echo $i;?> name="care_pers_info[care_cause_code][<?php echo $i;?>]" value="<?php echo $row['care_cause_code'];?>" <?php if($value_elderly['care_cause_code']==$row['cause_code']) {?>checked<?php }?>> <?php echo $row['cause_of_care'];?></label></div>
                                                              <?php
                                                              }
                                                              ?>
                                                            </div>
                                                            <div class="col-xs-12 col-sm-3">
                                                              <input id="care_cause_ident-<?php echo $i;?>" type="text" class="form-control" title="สาเหตุการพ้นการดูแลอื่น ๆ (ระบุ)" placeholder="อื่น ฯ (ระบุ)" name="care_pers_info[care_cause_identify][<?php echo $i;?>]" value="<?php $row['care_cause_identify'];?>" <?php if($value_elderly['care_cause_code']!='002'){?> disabled="" <?php }?>>
                                                            </div>
                                                          </div>
