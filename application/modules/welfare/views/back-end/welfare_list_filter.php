        ...
        <div class="form-group row">
          ...
          <div class="col-xs-12 col-sm-3">
            <select class="form-control" id="statusoper">
               ...
               <option value="date_of_req">แจ้งความประสงค์</option>
               <option value="date_of_adm">รับเข้า (วัน)</option>
               <option value="date_of_dis">จำหน่าย</option>
  ...
  // var gender = 'false';
    ...
    $('#datepicker').change(function(){
        ...
        var composedate = $('input[name=start]').val()+'_'+$('input[name=end]').val();
         if(statusoper == 'date_of_req'){
           $('#col5_filter').val(composedate);
         }else if(statusoper == 'date_of_adm'){
           $('#col6_filter').val(composedate);
         }else if(statusoper == 'date_of_dis'){
