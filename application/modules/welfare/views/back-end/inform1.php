                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li>
                              ...
                              ?>
                                <a <?php if(!isset($tmp1['perm_status'])) {?>
                                    readonly
                                  <?php }else if($process_action!='Add'){?> href="<?php echo site_url('welfare/admission2/Edit/'.@$adm_info['adm_id']);?>" <?php }?>  <?php if($usrpm['app_id']==14){?>aria-expanded="true" <?php }?>>(2) รับเข้า/จำหน่าย</a>
                            </li>
                            <li>
                              <?php
                              ...
                              ?>
                                <a <?php if(!isset($tmp1['perm_status'])) {?>
                                    readonly
                                  <?php }else if($process_action!='Add'){?> href="<?php echo site_url('welfare/estimate3/View/'.@$adm_info['adm_id']);?>" <?php }?>  <?php if($usrpm['app_id']==5){?>aria-expanded="true" <?php }?>>(3) ประเมินสมรรถภาพ</a>
                            </li>
                        </ul>
                  ...
                  <div class="panel-body" style="background-color:#FBFBFB;border: 1px #eee solid; padding: 15px;">
                    ...
                    <div class="form-group row">
                      <div class="col-xs-12 col-sm-3 ">
                        <label class="col-2 col-form-label" >เลขบัตรประจำตัวประชาชน</label>
                            <input id="pid_myID" title="เลขบัตรประจำตัวประชาชน" placeholder="เลขบัตรประจำตัวประชาชน (13 หลัก)" class="form-control input_idcard" type="text" name="pers_family[fml_pid][myID]"/>
                      </div>
                      ...
                      <div class="col-xs-12 col-sm-3">
                        ...
                        <input title="ชื่อตัว" placeholder="ระบุชื่อตัว" class="form-control" type="text" name="pers_family[pers_firstname_th][myID]" />
                      </div>
                      <div class="col-xs-12 col-sm-3">
                        <label class="col-2 col-form-label">ชื่อสกุล</label>
                        <input title="ชื่อสกุล" placeholder="ระบุชื่อสกุล" class="form-control" type="text" name="pers_family[pers_lastname_th][myID]" />
                      </div>
                    </div>
                    ...
                    <div class="form-group row">
                      <div class="col-xs-12 col-sm-3">
                        ...
                        <input title="อายุ" id="pers_age_myID" placeholder="ระบุอายุ (ปี)" class="form-control" type="text" value="" name="pers_family[fml_age][myID]"/>
                      </div>
                      <div class="col-xs-12 col-sm-3">
                                    ...
                                    <div class="panel-group" style="margin-bottom: 0px;">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                      ...
                                                      <div class="input-group" style="width: 295px;">
                                                         ...
                                                         <div class="input-group-btn" style="padding-bottom: 5px;">
                                                              <button title="ตรวจสอบ" class="btn btn-default" type="button" id="bt_req_pid" style="background-color:#F2DEDE; order-radius: 0px; left: 1px; border-color: #ed5565; color: #ed5565;padding:5px 12px;"><i class="fa fa-search" aria-hidden="true"></i></button>
                                                         </div>
                                                     </div>
                                                      ...
                                                      <button title="กรณีไม่มีบัตร" class="btn btn-default" style="width: 48%; display:none;">กรณีไม่มีบัตร</button>
                                          ...
                                          <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                      ...
                                                      <input title="เบอร์โทรศัพท์ (ที่ติดต่อได้)" placeholder="ตัวอย่าง 08XXXXXXXX" class="form-control" type="text" name="adm_info[req_tel_no_mobile]" value="<?php echo @$adm_info['req_tel_no_mobile'];?>"/>
                                                    </div>

                                                     <div class="col-xs-12 col-sm-6 dropdown has-error">
                                             ...
                                             <div class="panel-heading">
                                                <h4>ข้อมูลผู้สูงอายุ (ผู้ขอรับการสงเคราะห์) (
                                                  <div class="checkbox-inline i-checks"><label><input type="checkbox" name="elder_pers_chk" id="elder_pers_chk"  <?php if($adm_info['req_pers_id']==@$adm_info['pers_id'] && $adm_info['req_pers_id'] != ''){ echo "checked"; }?> > บุคคลเดียวกับผู้ยื่นคำขอ</label></div> )
                                                  <script>
                                                   ...
                                                   <img src="<?php echo path('noProfilePic.jpg','member');?>" class="img-responsive" style="margin: 0 auto; width: 70%;">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                       <div class="input-group" style="width: 295px;">
                                                          ...
                                                          <div class="input-group-btn" style="padding-bottom: 5px;">
                                                             <button title="ตรวจสอบ" class="btn btn-default elder_same_req" type="button" id="bt_elder_pid" style="background-color:#F2DEDE; border-radius: 0px; left: 1px; border-color: #ed5565; color: #ed5565;padding:5px 12px;"><i class="fa fa-search" aria-hidden="true"></i></button>
                                                          </div>
                                                       </div>
                                                      <input type="hidden" id="pers_id" name="adm_info[pers_id]" value="<?php echo @$adm_info['pers_id'];?>">
                                                    </div>

                                                      <button class="btn btn-default elder_same_req" title="กรณีไม่มีบัตร" style="width: 48%; display: none;">กรณีไม่มีบัตร</button>
                                              ...
                                              <input title="หมู่ที่" placeholder="" class="form-control elder_addr_pre" type="text" name="pers_addr[addr_moo]"/>
                                                  ...
                                                  <div class="form-group row">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3 dropdown">
                                                        ...
                                                        <div class="col-10">
                                                          <select title="อำเภอ" placeholder="เลือกอำเภอ" class="form-control elder_addr_pre" id="Amphur" name="pers_addr[addr_district]" onchange="optionGen(this,'Tambon');" disabled>
...
<!--                                                     <div class="col-xs-12 col-sm-3">
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                      <label class="col-2 col-form-label">เบอร์โทรศัพท์ (ที่ติดต่อได้)</label>
                                                      <input title="เบอร์โทรศัพท์ (ที่ติดต่อได้)" placeholder="ตัวอย่าง 08XXXXXXXX" class="form-control" type="text" name="pers_info[tel_no_mobile]" value="<?php echo @$adm_info['tel_no_mobile'];?>"/>
                                                    </div>
                                              ...
                                              <input title="อาชีพ (ปัจจุบัน)" placeholder="ระบุอาชีพ (ปัจจุบัน)" class="form-control" type="text" name="pers_info[occupation]"/>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <label class="col-2 col-form-label">รายได้เฉลี่ย (บาท/เดือน)</label>
                                              <input title="รายได้เฉลี่ย (บาท/เดือน)" placeholder="ระบุรายได้เฉลี่ย (บาท/เดือน)" class="form-control numberonly" type="text" name="pers_info[mth_avg_income]"/>
                                                    </div>
                                              ...
                                              <input title="ระบุ" placeholder="ระบุ" class="form-control" type="text" name="pers_info[src_of_income_identify]"/>
                                                    </div>
                                                  </div>
                                                  ...
                                                  <div class="form-group row">
                                                    <div class="col-xs-12 col-sm-3">
                                                        ...
                                                        <div class="checkbox-inline i-checks"><label><input type="radio" name="1"> ไม่มีหนี้สิน</label></div>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                                        <label class="col-2 col-form-label">&nbsp;</label><br>
                                                        <div class="checkbox-inline i-checks"><label><input type="radio" name="1"> มีหนี้สิน</label></div>
                                                    </div>

                                                    <div class="col-xs-12 col-sm-3">
                                                        <label class="col-2 col-form-label">เงินกู้ในระบบ (บาท)</label>
                                              <input title="เงินกู้ในระบบ" placeholder="ระบุจำนวนเงิน (บาท)" class="form-control numberonly" type="text"/>
                                                    </div>

                                                    <div class="col-xs-12 col-sm-3">
                                                        <label class="col-2 col-form-label">เงินกู้นอกระบบ (บาท)</label>
                                              <input title="เงินกู้นอกระบบ" placeholder="ระบุจำนวนเงิน (บาท)" class="form-control numberonly" type="text"/>
                                                    </div>
                                                  </div>
                              ...
                              <div class="panel panel-default" style="border: 0">
                                ...
                                <div class="panel-body" style="background-color:#FBFBFB;border: 1px #eee solid; padding: 15px;">
                                  ...
                                  <div class="form-group row">
                                    <div class="col-xs-12 col-sm-3">
                                      <label class="col-2 col-form-label">เลขบัตรประจำตัวประชาชน</label>
                                      <input  id="pid_<?php echo $key;?>" value="<?php echo $row['fml_pid'];?>" title="เลขบัตรประจำตัวประชาชน" placeholder="เลขบัตรประจำตัวประชาชน (13 หลัก)" class="form-control input_idcard" type="text" name="pers_family[fml_pid][<?php echo $key;?>]"/>
                                    </div>
                                    <div class="col-xs-12 col-sm-3 dropdown">
                                      <label for="example-text-input" class="col-2 col-form-label">คำนำหน้านาม</label>
                                      <div class="col-10">
                                  ...
                                  <div class="form-group row">
                                    <div class="col-xs-12 col-sm-3">
                                      <label class="col-2 col-form-label">อายุ (ปี)</label>
                                      <input title="อายุ" id="pers_age_<?php echo $key;?>" placeholder="ระบุอายุ (ปี)" class="form-control" type="text" name="pers_family[fml_age][<?php echo $key;?>]" value="<?php echo @$row['fml_age'];?>" />
                                    </div>
                                    <div class="col-xs-12 col-sm-3">
                                      <label class="col-2 col-form-label">เกี่ยวของเป็น</label>
                                                                       ...
                                                                       <div class="form-group row" style="margin-bottom: 10px;">
                                                                            <div class="col-xs-12 col-sm-6">
                                                                                  <div class="form-group row"><!-- row leverl 2-->
                                                                                      <div class="col-xs-12 col-sm-12"><b>ลักษณะความพิการ (ถ้ามี)</b></div>
                                                                                      ...
                                                                                      foreach ($tmp_dis as $key => $value) { ?>
                                                                                        ...
                                                                                        <div class="col-xs-12 col-sm-6" ><div class="i-checks"><label><input type="checkbox" name="pers_disability[dis_code][<?php echo $value['dis_code'] ?>]" value="<?php echo $value['dis_code'] ?>"  <?php if(@$pers_disability[$value['dis_code']]['dis_code'] == $value['dis_code']){ echo 'checked';} ?>>  <?php echo $value['dis_title']; ?></label></div></div>
                                                                                        <div class="col-xs-12 col-sm-6" ><input type="text" class="form-control" placeholder="ระบุ" id="dis-<?php echo $value['dis_code']; ?>" name="pers_disability[dis_remark][<?php echo $value['dis_code']; ?>]" value="<?php echo @$pers_disability[$value['dis_code']]['dis_remark']; ?>" <?php if(!isset($pers_disability[$value['dis_code']]['dis_remark'])) { echo "disabled";} ?>></div>
                                                                            ...
                                                                            <div class="col-xs-12 col-sm-6">
                                                                                  <div class="row"><!-- row leverl 2-->
                                                                                      <div class="col-xs-12 col-sm-12"><b>โรคประจำตัว (ถ้ามี)</b></div>
                                                                                      <div class="col-xs-12 col-sm-12"><br></div>
                                                                                      <div class="col-xs-12 col-sm-12"><textarea class="form-control" rows="4" name="pers_info[healthy_congenital_disease]"><?php echo @$pers_info['healthy_congenital_disease']; ?></textarea></div>
                                                                                      <div class="col-xs-12 col-sm-12"><br></div>
                                                                                      <div class="col-xs-12 col-sm-12"><b>ประวัติการแพ้ยา (ถ้ามี)</b></div>
                                                                                      <div class="col-xs-12 col-sm-12"><br></div>
                                                                                      <div class="col-xs-12 col-sm-12"><textarea class="form-control" rows="4" name="pers_info[healthy_drug_allergy]"><?php echo @$pers_info['healthy_drug_allergy']; ?></textarea></div>
                                                                                  </div>
                                                                            </div>
                                                                       </div>
