                                    ...
                                    <div class="panel-group">
                                          <div class="panel panel-default" style="border: 0">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                      ...
                                                      <div class="input-group" style="width: 295px;"> 
                                                         ...
                                                         <div class="input-group-btn" style="padding-bottom: 5px;">
                                                              <button title="ตรวจสอบ" class="btn btn-default" type="button" id="bt_req_pid" style="border-radius: 0px; left: 1px;"><i class="fa fa-id-card-o" aria-hidden="true"></i></button>
                                                         </div>
                                                     </div>
                                              ...
                                              <div id="datetimepicker1" class="col-10 input-group date" data-date-format="dd-mm-yyyy">
                                                  <input title="วันที่แจ้งเรื่อง" placeholder="เลือกวันที่" class="form-control" type="text" name="adm_info[date_of_req]" value="<?php echo $adm_info['date_of_req']; ?>" />
                                              ...
                                              <input title="ตำแหน่ง" placeholder="ระบุตำแหน่ง" class="form-control" type="text" name="adm_info[req_position]" value="<?php echo @$adm_info['req_position'];?>"/>
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <label for="" class="col-2 col-form-label">หนว่ยงาน</label>
                                              <input title="หนว่ยงานต้นสังกัด" placeholder="ระบุหนว่ยงานต้นสังกัด" class="form-control" type="text" name="adm_info[req_org]" value="<?php echo @$adm_info['req_org'];?>"/>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-3">
                                                        <label for="" class="col-2 col-form-label">เกียวข้องเป็น</label>
                                          ...
                                          <div class="form-group row">
                                             ...
                                             <div class="panel-heading">
                                                <h4>ข้อมูลผู้สูงอายุ (ผู้ขอรับการสงเคราะห์) (
                                                  <div class="checkbox-inline i-checks"><label><input type="checkbox" name="elder_pers_chk"> บุคคลเดียวกับผู้ยื่นคำขอ</label></div> ) 
                                                  <script>
                                                ...
                                                <div class="form-group row ">
                                                    ...
                                                    <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                       <div class="input-group" style="width: 295px;">
                                                          ...
                                                          <div class="input-group-btn" style="padding-bottom: 5px;">
                                                             <button title="ตรวจสอบ" class="btn btn-default elder_same_req" type="button" id="bt_elder_pid" style=" border-radius: 0px;  left: 1px;"><i class="fa fa-id-card-o" aria-hidden="true"></i></button>
                                                          </div>
                                                       </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td id="row7_state"><i class="fa fa-times text-danger"></i></td>
                                              ...
                                              <input title="อาชีพ (ปัจจุบัน)" placeholder="ระบุอาชีพ (ปัจจุบัน)" class="form-control" type="text" name="pers_info[occupation]"/>                   
                                                    ...
                                                    <div class="col-xs-12 col-sm-3">
                                                        <label for="" class="col-2 col-form-label">รายได้เฉลี่ย (บาท/เดือน)</label>
                                              <input title="รายได้เฉลี่ย (บาท/เดือน)" placeholder="ระบุรายได้เฉลี่ย (บาท/เดือน)" class="form-control" type="text" name="pers_info[mth_avg_income]"/>                   
                                                    </div>
                                              ...
                                              <input title="เงินกู้ในระบบ" placeholder="ระบุจำนวนเงิน (บาท)" class="form-control" type="text"/>
                                                    </div>

                                                    <div class="col-xs-12 col-sm-3">
                                                        <label for="" class="col-2 col-form-label">เงินกู้นอกระบบ (บาท)</label>
                                              <input title="เงินกู้นอกระบบ" placeholder="ระบุจำนวนเงิน (บาท)" class="form-control" type="text"/>
                                                    </div>
                                                  </div>
                                                ...
                                                <div class="row">
                                                  <label>สมาชิกในครอบครัว (จำนวน <span id="nums_family_members">0</span> คน)</label>
                                                  <script>
                                                    var nummf = 0;
                                    ...
                                    ?>
                                      ...
                                      <hr style="margin-top: 0px;">
                                        ...
                                        <div class="col-xs-12 col-sm-2">
                                          <button style="width: 100%;" type="button" class="btn btn-primary btn-md" onclick="window.location.href='<?php echo site_url('welfare/welfare_list');?>'"> ล้างค่า</button>
                                        </div>
                                      </div><!-- close class row-->
