                                          ...
                                          <div class="panel panel-default" style="border: 0;">
                                            ...
                                            <div class="panel-body" style="border: 0;padding: 20px; padding-bottom: 5px;">
                                              <div class="form-group row">
                                                <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">เลขประจำตัวประชาชน: </span><?php echo $adm_info['pid'];?></div>
                                                <div class="col-xs-12 col-sm-3" style="padding: 7px 15px;"><span style="font-weight: bold;">ชื่อตัว/ชื่อสกุล: </span><?php echo $adm_info['name'];?></div>
