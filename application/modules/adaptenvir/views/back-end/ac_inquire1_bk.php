                            ...
                            <li class="active">
                              ...
                              ?>
                                <a <?php if(!isset($tmp1['perm_status'])) {?>
                                    readonly
                                  <?php }else if($process_action!='Add'){?> href="<?php echo site_url('adaptenvir/ac_inquire1/Edit/'.$impv_place_info['impv_place_id']);?>" <?php }?> data-toggle="tab" <?php if($usrpm['app_id']==37){?>aria-expanded="true" <?php }else{?> aria-expanded="false"<?php }?>> (1) สอบถาม</a>
                            </li>
                            <li>
                              <?php
                                ...
                                <div class="panel-body">
                                    ...
                                    <div id="tmp_menu" hidden='hidden'>
                                       <!--
                                        ...
                                        <?php if(!isset($tmp1['perm_status'])) {?>
                                                readonly 
                                              <?php }else{?> href="<?php echo site_url('adaptenvir/activity_list');?>" 
                                        <?php }?> title="<?php if(isset($tmp['app_name'])){echo $tmp['app_name'];}?>">
                                    ...
                                    <div class="panel-group">
                                                        ...
                                                        <div class="col-xs-12 col-sm-3">
                                                            <label for="datetimepicker1" class="col-2 col-form-label" style="color: red;">วันที่สอบถาม </label>
                                                              <div id="datetimepicker1" class="col-10 input-group date has-error" data-date-format="dd-mm-yyyy">
                                                                  <input title="วันที่สอบถาม" placeholder="เลือกวันที่" class="form-control" type="text" name="impv_place_info[date_of_svy]" value="<?php echo $impv_place_info['date_of_svy']; ?>" required>
                                              ...
                                              <input title="หมู่ที่" placeholder="" class="form-control elder_addr_pre" type="text" name="pers_addr[addr_moo]" value="<?php echo @$addr_info['addr_moo']; ?>"/>                    
                                                  ...
                                                  <div class="row">
                                                   ...
                                                   <div class="form-group row"><!-- row leverl 2-->
                                                    ...
                                                    <div class="col-xs-12 col-sm-12"><br></div>
                                                    <div class="col-xs-12 col-sm-6"><div class="checkbox-inline i-checks"><label><input type="radio" name="impv_place_info[staff_review]" value="เห็นควรให้ความช่วยเหลืออย่างด่วน" <?php if(@$impv_place_info['staff_review'] == "เห็นควรให้ความช่วยเหลืออย่างด่วน"){ echo "checked";} ?>>  เห็นควรให้ความช่วยเหลืออย่างด่วน</label></div></div>
                                                    <div class="col-xs-12 col-sm-6"><input type="text" id="staff_review_remark-2" class="form-control" placeholder="ความคิดเห็นเจ้าหน้าที่ (ผู้สอบถาม)" name="impv_place_info[staff_review_remark]" value="<?php if(@$impv_place_info['staff_review'] == "เห็นควรให้ความช่วยเหลืออย่างด่วน" ){ echo @$impv_place_info['staff_review_remark']; } ?>" <?php if(@$impv_place_info['staff_review'] != "เห็นควรให้ความช่วยเหลืออย่างด่วน"){ echo "disabled"; } ?>></div>
                                                   </div>
                                      ...
                                      <div class="col-xs-12 col-sm-2">
                                        <button style="width: 100%;" type="button" class="btn btn-primary btn-md" onclick="window.location.href='<?php echo site_url('adaptenvir/activity_list');?>'"> ล้างค่า</button>
                                      </div>
                                    </div><!-- close class row-->
