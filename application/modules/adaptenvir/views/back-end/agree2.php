                                                       ...
                                                       <div class="form-group row">
                                                            ...
                                                            <div class="col-xs-12 col-sm-6 has-error" style="padding: 3px 15px;">
                                                              <div class="input-group" style="width: 295px;">
                                                                <input  title="เลขประจำตัวประชาชน" placeholder="เลขประจำตัวประชาชน (13 หลัก)" class="form-control input_idcard elder_same_req" type="text" id="pid" name="" value="<?php echo $impv_home_info['pid'];?>" required/>
                                                                <input type="hidden" id="pers_id" name="impv_home_info[cns_pers_id]" value="<?php echo $impv_home_info['cns_pers_id'];?>">
                                                         ...
                                                         <div class="form-group row">
                                                           <div class="col-xs-12 col-sm-3">
                                                            ...
                                                            <div class="col-xs-12 col-sm-6">
                                                               ...
                                                               <select class="form-control" name="impv_home_info[cns_status]">
                                                            ...
                                                            <div class="col-xs-12 col-sm-3">
                                                               ...
                                                               <input type="text" class="form-control" name="impv_home_info[cns_relation]" value="<?php echo $impv_home_info['cns_relation']; ?>" placeholder="ระบุความสัมพันธ์กับผู้อายุ">
                                                            </div>
                                                         </div><!-- close form-group row-->

                                                         <!--<div class="form-group row"><div class="col-xs-12 col-sm-12"><br></div></div>-->
                                                         <div class="form-group row">
                                                              <div class="col-xs-12 col-sm-6"><label>ที่อยู่ (บ้านพักอาศัยของผู้สูงอายุที่ต้องการปรับปรุง) </label> ( <div class="checkbox-inline i-checks"><label><input type="checkbox" name="elder_addr_chk"> ตรงกับที่อยู่ตามทะเบียนบ้าน</label></div> )</div>
                                                              <script>
                                                         ...
                                                         <div class="form-group row">
                                                           <div class="col-xs-12 col-sm-6 dropdown">
                                                               ...
                                                               <input title="ตัวแทนของข้าพเจ้าชื่อ" placeholder="(คำนำหน้าชื่อ) ชื่อ-นามสกุล" class="form-control elder_addr_pre" name="impv_home_info[cns_delegate]" value="<?php echo @$impv_home_info['cns_delegate'];?>" type="text"/>
                                                           </div>
                                                           <div class="col-xs-12 col-sm-3">
