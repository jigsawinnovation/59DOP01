<script>
  var dtable_url = '<?php echo site_url('adaptenvir/activity_list_ajax');?>';
  var csrf_hash='<?php echo @$csrf['hash'];?>';
                          ...
                          <?php
                            //summary
                            $this->load->file(APPPATH.'modules/'.uri_seg(1).'/views/back-end/activity_list_summary.php');
                            //search
                            $this->load->file(APPPATH.'modules/'.uri_seg(1).'/views/back-end/activity_list_filter.php');
                          ?>
