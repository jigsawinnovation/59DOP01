    ...
    table = $('#dtable').DataTable({
           ...
           complete: function(response) {
             ...
             if(rs>0) {
               ...
               for(i=0;i<rs;i++) {
                 ...
                 html+="<li><a href='"+base_url+"report/B0/xls?sheet="+(i+1)+"' target='_blank'>ไฟล์ที่ "+(i+1)+" รายการที่ "+Number(sort.toFixed(1)).toLocaleString()+"-"+Number(dest.toFixed(1)).toLocaleString()+"</a></li>";
               }
      ...
      //Set column definition initialisation properties.
       "columnDefs": [
        ...
        { "name": "A.date_of_adm",    "targets": 6 },
        { "name": "A.date_of_dis",    "targets": 7 },
        { "name": "start_age",    "targets": 8 },
        { "name": "end_age",    "targets": 9 },
        { "name": "A.insert_org_id", "targets": 11 ,"visible": false}
      ],
      "order": [[ 0, "desc" ]],
