           ...
           complete: function(response) {
             ...
             if(rs>0) {
               ...
               for(i=0;i<rs;i++) {
                 ...
                 html+="<li><a href='"+base_url+"report/C0/xls?sheet="+(i+1)+"' target='_blank'>ไฟล์ที่ "+(i+1)+" รายการที่ "+Number(sort.toFixed(1)).toLocaleString()+"-"+Number(dest.toFixed(1)).toLocaleString()+"</a></li>";
               }
